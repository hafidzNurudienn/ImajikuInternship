...
<body>
    <section id="image-preview" data-variant="1" data-background="hide">
        <div class="max-div d-flex flex-column container">
            <div class="summary-box" data-variant="image-preview-2">
            ...
            <div class="content-box" data-variant="image-preview-2" id="mixGrid">
    ...
    <script>
        const fetchAllTwo = async () => {
            try {
                ...
                renderGaleri(favourite.slice(0, 8));
            } catch (error) {
